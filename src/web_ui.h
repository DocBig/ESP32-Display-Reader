  ...
  <div class="configSections">
      ...
      <div id="camera_content" class="collapsibleContent hidden">
        <label>ESP32 Board Model
          <select id="cam_model">
            ...
            <option value="atoms3r_m12">M5Stack AtomS3R M12</option>
          </select>
        </label>
    ...
    <div class="collapsibleSection">
      ...
      <div id="lighting_content" class="collapsibleContent hidden">
        ...
        <button type="button" id="btnLightTest" onclick="testLight()">Test Light</button>
    ...
    <div class="collapsibleSection">
      ...
      <div id="lighting2_content" class="collapsibleContent hidden">
        ...
        <button type="button" id="btnLight2Test" onclick="testLight2()">Test WS2812B</button>
