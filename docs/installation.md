...
Ein Installer für alle Boards — er erkennt den angeschlossenen Chip automatisch (ESP32-CAM, WROVER
oder AtomS3R M12) und flasht die passende Firmware.

1. Board per USB mit dem Rechner verbinden
...
4. Flash-Vorgang abwarten — das Board startet automatisch neu

> ⚠️ Der Web Installer überträgt immer die aktuelle Firmware-Version.

> 🧪 **M5Stack AtomS3R M12 ist Beta:** Kamera-Pins und GPIO18-Power-Sequenz sind noch nicht auf
> echter Hardware verifiziert — siehe Warnhinweis auf der Installer-Seite.
